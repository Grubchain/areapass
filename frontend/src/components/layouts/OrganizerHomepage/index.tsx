                        ...
                        <div className={classes.footerSection}>
                            <div className={classes.footerContent}>
                                <div className={classes.footerLinks}>
                                    <Anchor
                                        href={getConfig('VITE_GRUBCHAIN_PRIVACY', 'https://hi.events/privacy-policy?utm_source=app-organizer-footer')}
                                    ...
                                    <Anchor
                                        href={getConfig('VITE_GRUBCHAIN_TOS', 'https://hi.events/terms-of-service?utm_source=app-organizer-footer')}
                                        className={classes.footerLink}
                                    >
                                        {t`Terms of Service`}
                                    </Anchor>
