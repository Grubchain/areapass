...
export const clientBuildEnv: { [K in ConfigKeys]: string } = {
  ...
  VITE_GRUBCHAIN_URL: import.meta.env.VITE_GRUBCHAIN_URL,
  VITE_GRUBCHAIN_TOKENIZER_URL: import.meta.env.VITE_GRUBCHAIN_TOKENIZER_URL,
  VITE_GRUBCHAIN_APP_KEY: import.meta.env.VITE_GRUBCHAIN_APP_KEY,
  VITE_GRUBCHAIN_SECRET_KEY: import.meta.env.VITE_GRUBCHAIN_SECRET_KEY,
  VITE_GRUBCHAIN_ISS: import.meta.env.VITE_GRUBCHAIN_ISS,
  ...
  VITE_GRUBCHAIN_BANK_ACCOUNT_TRANSFER: import.meta.env.VITE_GRUBCHAIN_BANK_ACCOUNT_TRANSFER,
  VITE_GRUBCHAIN_BANK_ACCOUNT_NUMBER: import.meta.env.VITE_GRUBCHAIN_BANK_ACCOUNT_NUMBER
};
